...
namespace MatomoDeviceDetectorNET.Services.Parser.Client
{
    ...
    public class BrowserParser : ClientParserAbstract<List<Services.Client.Browser>, BrowserMatchResult>
    {
        ...
        private static Dictionary<string, string[]> browserFamilies = new Dictionary<string, string[]>
        {
            ...
            { "Firefox", new[] { "FF", "FE", "FM", "SX", "FB", "PX", "MB", "EI", "WF", "CU", "TF", "QM", "FR", "I4", "GZ", "MO", "F1", "BI", "MN", "BH", "TO", "OS", "MY", "FY", "AX", "C0", "LH", "S5", "ZV", "IW", } },
        ...
        /// </summary>
        private static string[] mobileOnlyBrowsers = { "36", "OC", "PU", "SK", "MF", "OI", "OM", "DD", "DB", "ST", "BL", "IV", "FM", "C1", "AL", "SA", "SB", "FR", "WP", "HA", "NX", "HU", "VV", "RE", "CB", "MZ", "UM", "FK", "FX", "WI", "MN", "M1", "AH", "SU", "EU", "EZ", "UT", "DT", "S0", "QU", "YN", };
